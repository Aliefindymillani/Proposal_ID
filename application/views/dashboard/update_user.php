        ...
        <div class="p-5">
            ...
            <form class="user py-4" action="<?php echo base_url() . 'admin/update' ?>" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-12">
                            <input type="text" class="form-control form-control-user" name="username"
                                placeholder="Username" value="<?php echo $update->username ?>" readonly>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="mb-3 row">
                        ...
                        <div class="col-12">
                            <input type="text" class="form-control form-control-user" id="staticEmail" name="email"
                                placeholder="Email" value="<?php echo $update->email ?>">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="mb-3 row">
                        ...
                        <div class="col-12">
                            <input type="hidden" class="form-control form-control-user" name="password"
                                required="required" placeholder="Password" value="<?php echo $update->password ?>"
                                readonly>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="mb-3 row">
                        <div class="col-12">
                            <input type="hidden" class="form-control form-control-user" name="akses" required="required"
                                value="<?php echo $update->akses ?>" readonly>
                        </div>
                    </div>
                </div>
                <br>
                ...
                <br>
                <div class="text-center">
                    <a href="<?php echo base_url() . 'admin/list-user' ?>"
                        class="btn btn-dark btn-user col-7">Kembali</a>
                </div>
            </form>
            <br>
        </div>
